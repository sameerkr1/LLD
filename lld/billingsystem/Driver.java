...
public class Driver {
    ...
    public static void main(String[] args) {
        AllenCabDriverBillingSystem allenCabDriverBillingSystem = new AllenCabDriverBillingSystem();
        ...
        allenCabDriverBillingSystem.addTrip(50.0, 1723116023, 1723117023,
                "INTRACITY", "COMPLETED", "Ramesh");
